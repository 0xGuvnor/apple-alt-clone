...
const Hero = () => {
  return (
    <section className="sticky inset-x-0 top-0 flex flex-col md:flex-row mx-auto h-screen max-w-[1350px] items-center md:justify-between px-8 mt-4 space-y-8 md:mt-0 md:space-y-0">
