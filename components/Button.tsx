  ...
  return (
    <button
      ...
      className={`relative inline-flex items-center justify-center ${padding} px-5 py-2 ${
        width ? width : "w-auto"
      } overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out rounded shadow-xl group hover:ring-1 hover:ring-purple-500`}
    >
      <span className="absolute inset-0 w-full h-full bg-gradient-to-br from-pink-500 via-purple-500 to-violet-500"></span>
